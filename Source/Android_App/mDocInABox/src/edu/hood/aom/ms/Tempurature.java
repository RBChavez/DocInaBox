 ...
 *
 */
public class Tempurature extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tempurature);
       ...
       // mGraph = (GraphView)findViewById(R.id.graph);
        ...
        GPDEG = (GraphView) findViewById(R.id.GPDEG);
        GPDEG.setMaxValue(120);
				...
				if (data != null){
					...
					for(String _Case : Values)
					{
						...
						case 7 : 	TVDEG.setText(Condition[1]);
									GPDEG.addDataPoint(Integer.parseInt(Condition[1]));
						break;
						}
					}
